...
public class SoulWizardRenderer extends GeoEntityRenderer<SoulWizardEntity> {
    ...
    public SoulWizardRenderer(EntityRendererProvider.Context renderManager) {
        ...
        this.addLayer(new PulsatingGlowLayer<>(this, ResourceLocation.fromNamespaceAndPath(DungeonsGear.MODID, "textures/entity/ghosts/soul_wizard_glow.png"), 0.2F, 1.0F, 0.25F));
    }
